...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white flex justify-between items-center w-[90vw] md:w-[80vw] fixed top-3 md:top-6 left-1/2 transform -translate-x-1/2 rounded-full p-1.5 md:p-2 shadow-md z-50">
      {/* Logo - Left Side */}
      <Link href={"/"} className="flex-shrink-0">
        <svg
          className="h-5 md:h-6 ml-4 "
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-6">
          <ul className="flex gap-10 text-black">
            <Link href=""><li className="hover:text-orange-500">Template</li></Link>
            <Link href=""><li className="hover:text-orange-500">Marketplace</li></Link>
            <Link href="./pricing"><li className="hover:text-orange-500">Pricing</li></Link>
          </ul>
          <div className="flex gap-3">
            <Link href="./login">
              <button className="bg-gray-600 text-white font-bold rounded-full px-4 py-1.5 hover:bg-slate-800 text-sm">
                Login
              </button>
            </Link>
            <Link href="./">
              <button className="bg-gray-900 text-white rounded-full px-4 py-1.5 font-bold hover:bg-slate-700 text-sm">
                Sign up free
              </button>
            </Link>
          </div>
      ...
      <div className={`md:hidden absolute top-full left-0 w-full bg-white rounded-lg shadow-lg mt-1 ${isMenuOpen ? 'block' : 'hidden'}`}>
        <div className="p-3 space-y-3">
          <Link href=""><div className="text-black hover:text-gray-600 p-1">Template</div></Link>
          <Link href=""><div className="text-black hover:text-gray-600 p-1">Marketplace</div></Link>
          <Link href="./pricing"><div className="text-black hover:text-gray-600 p-1">Pricing</div></Link>
          <div className="pt-3 border-t border-gray-200 space-y-2">
            <Link href="./login">
              <button className=" bg-gray-600 text-white font-bold rounded-full px-4 py-2 hover:bg-gray-800">
                Login
              </button>
            </Link>
            <br />
            <Link href="./">
              <button className=" bg-gray-900 text-white rounded-full px-4 py-2 font-bold hover:bg-slate-600 mt-2">
                Sign up free
              </button>
            </Link>
          </div>
